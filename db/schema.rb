...
ActiveRecord::Schema.define(version: 2022_02_20_075714) do
  ...
  create_table "onboarding_surveys", force: :cascade do |t|
    t.string "title", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "payment_infos", force: :cascade do |t|
    ...
    t.datetime "date_expiration", precision: 6, null: false
    t.integer "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "date_graduated", precision: 6
